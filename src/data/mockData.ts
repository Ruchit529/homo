...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    council_leadership: "Council Leadership",
    admin_name: "Shri Sanjay Mishra (IAS)",
    admin_role: "AYUSH Administrator",
    admin_dept: "Additional Secretary, Govt. of M.P.",
    reg_dept: "M.P. State Homeopathy Council",
  ...
  hi: {
    ...
    council_leadership: "परिषद नेतृत्व",
    admin_name: "श्री संजय मिश्रा (आई.ए.एस.)",
    admin_role: "प्रशासक (आयुष)",
    admin_dept: "अपर सचिव, मध्य प्रदेश शासन",
    reg_dept: "म.प्र. राज्य होम्योपैथी परिषद",
